...
public class EEGSc1 : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        eegData = new EGGData(
            $"{Application.dataPath}/Data/{LevelScript.UserGroup}/{LevelScript.UserName + "_" + date}/Sc1LivingRoom/EEG/"
    ...
    private string GetRecordingPath()
    {
        ...
        string date = System.DateTime.Now.ToString("yyyy_MM_dd");
        path = $"{Application.dataPath}/Data/{LevelScript.UserGroup}/{LevelScript.UserName + "_" + date}/Sc1LivingRoom/EEG/"; 
