...
public class Sc1OnCollisionEye : TimeSync
{
    ...
    void LookedAt(string lookedAtWhat)
    {
        ...
        string path = $"{Application.dataPath}/Data/{LevelScript.UserGroup}/{LevelScript.UserName + "_" + date}/Sc1LivingRoom/EyeTracking/" + LevelScript.UserName + "_" + "LookedAt.csv";
