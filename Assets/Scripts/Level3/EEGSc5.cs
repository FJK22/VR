...
public class EEGSc5 : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        eegData = new EGGData(
            $"{Application.dataPath}/Data/{LevelScript.UserGroup}/{LevelScript.UserName + "_" + date}/Sc5Street/EEG/"
    ...
    private string GetRecordingPath()
    {
        ...
        string date = System.DateTime.Now.ToString("yyyy_MM_dd");
        path = $"{Application.dataPath}/Data/{LevelScript.UserGroup}/{LevelScript.UserName + "_" + date}/Sc5Street/EEG/"; 
...
public class EGGData5{
    ...
    public EGGData5(string path, string file)
    {
