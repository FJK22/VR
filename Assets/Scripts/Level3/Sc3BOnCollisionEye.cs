...
public class Sc3BOnCollisionEye : TimeSync
{
    ...
    void LookedAt(string lookedAtWhat)
    {
        ...
        string path = $"{Application.dataPath}/Data/{LevelScript.UserGroup}/{LevelScript.UserName + "_" + date}/Sc5Street/EyeTracking/" + LevelScript.UserName + "_" + "LookedAt.csv";
