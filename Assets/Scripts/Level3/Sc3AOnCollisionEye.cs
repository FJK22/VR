...
public class Sc3AOnCollisionEye : TimeSync
{
    ...
    void LookedAt(string lookedAtWhat)
    {
        ...
        string path = $"{Application.dataPath}/Data/{LevelScript.UserGroup}/{LevelScript.UserName + "_" + date}/Sc4Street/EyeTracking/" + LevelScript.UserName + "_" + "LookedAt.csv";
