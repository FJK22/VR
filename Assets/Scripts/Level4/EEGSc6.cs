...
public class EEGSc6 : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        eegData = new EGGData(
            $"{Application.dataPath}/Data/{LevelScript.UserGroup}/{LevelScript.UserName + "_" + date}/Sc6Bar/EEG/"
    ...
    private string GetRecordingPath()
    {
        ...
        string date = System.DateTime.Now.ToString("yyyy_MM_dd");
        path = $"{Application.dataPath}/Data/{LevelScript.UserGroup}/{LevelScript.UserName + "_" + date}/Sc6Bar/EEG/"; 
...
public class EGGData6{
    ...
    public EGGData6(string path, string file)
    {
