...
public class EEGSc9 : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        eegData = new EGGData(
            $"{Application.dataPath}/Data/{LevelScript.UserGroup}/{LevelScript.UserName + "_" + date}/Sc9Elevator/EEG/"
    ...
    private string GetRecordingPath()
    {
        ...
        string date = System.DateTime.Now.ToString("yyyy_MM_dd");
        path = $"{Application.dataPath}/Data/{LevelScript.UserGroup}/{LevelScript.UserName + "_" + date}/Sc9Elevator/EEG/"; 
...
public class EGGData9{
    ...
    public EGGData9(string path, string file)
    {
