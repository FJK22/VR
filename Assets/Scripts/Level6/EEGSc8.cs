...
public class EEGSc8 : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        eegData = new EGGData(
            $"{Application.dataPath}/Data/{LevelScript.UserGroup}/{LevelScript.UserName + "_" + date}/Sc8TrainStation/EEG/"
    ...
    private string GetRecordingPath()
    {
        ...
        string date = System.DateTime.Now.ToString("yyyy_MM_dd");
        path = $"{Application.dataPath}/Data/{LevelScript.UserGroup}/{LevelScript.UserName + "_" + date}/Sc8TrainStation/EEG/"; 
...
public class EGGData8{
    ...
    public EGGData8(string path, string file)
    {
