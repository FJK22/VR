...
public class Sc2AOnCollisionEye : TimeSync
{
    ...
    void LookedAt(string lookedAtWhat)
    {
        ...
        string path = $"{Application.dataPath}/Data/{LevelScript.UserGroup}/{LevelScript.UserName + "_" + date}/Sc2LectureHall/EyeTracking/" + LevelScript.UserName + "_" + "LookedAt.csv";
