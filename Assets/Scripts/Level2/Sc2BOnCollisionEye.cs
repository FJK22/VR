...
public class Sc2BOnCollisionEye : TimeSync
{
    ...
    void LookedAt(string lookedAtWhat)
    {
        ...
        string path = $"{Application.dataPath}/Data/{LevelScript.UserGroup}/{LevelScript.UserName + "_" + date}/Sc3LectureHall/EyeTracking/" + LevelScript.UserName + "_" + "LookedAt.csv";
